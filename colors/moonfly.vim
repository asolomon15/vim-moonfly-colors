...
let s:grey233     = "#151515" " grey233     = 233
...
let s:light_blue  = "#78c2ff" " light_blue  = 15
...
if g:moonflyTerminalColors
    ...
    let g:terminal_color_15 = "#78c2ff"
...
" Functions.
exec "highlight Function ctermfg=15 guifg=" . s:light_blue
...
if g:moonflySpellInverse
    ...
    exec "highlight SpellLocal ctermbg=15 guibg=" . s:light_blue . " ctermfg=236 guifg=" . s:grey236 . " gui=none"
else
...
exec "highlight SpecialKey ctermbg=bg guibg=bg ctermfg=15 guifg=" . s:light_blue
exec "highlight MatchParen ctermbg=bg guibg=bg ctermfg=9 guifg=" . s:crimson . " cterm=underline gui=underline"
exec "highlight Ignore ctermfg=15 guifg=" . s:light_blue
...
exec "highlight pythonCoding ctermfg=15 guifg=" . s:light_blue
...
exec "highlight pythonRun ctermfg=15 guifg=" . s:light_blue
...
exec "highlight rubyAttribute ctermfg=15 guifg=" . s:light_blue
exec "highlight rubyBlockParameter ctermfg=2 guifg=" . s:green
exec "highlight rubyBoolean ctermfg=6 guifg=" . s:turquoise
exec "highlight rubyCallback ctermfg=15 guifg=" . s:light_blue
...
exec "highlight rubyEntities ctermfg=15 guifg=" . s:light_blue
...
exec "highlight rubyMacro ctermfg=15 guifg=" . s:light_blue
...
exec "highlight crystalAttribute ctermfg=15 guifg=" . s:light_blue
...
exec "highlight elixirExUnitMacro ctermfg=15 guifg=" . s:light_blue
...
exec "highlight jsFuncCall ctermfg=15 guifg=" . s:light_blue
...
exec "highlight jsObjectKey ctermfg=15 guifg=" . s:light_blue
...
exec "highlight coffeeObjAssign ctermfg=15 guifg=" . s:light_blue
...
exec "highlight goFunction ctermfg=3 guifg=" . s:blue
exec "highlight goFunctionCall ctermfg=15 guifg=" . s:light_blue
exec "highlight goLabel ctermfg=3 guifg=" . s:khaki
exec "highlight goMethod ctermfg=15 guifg=" . s:light_blue
exec "highlight goMethodCall ctermfg=15 guifg=" . s:light_blue
...
exec "highlight rustModPath ctermfg=15 guifg=" . s:light_blue
...
exec "highlight javaConstant ctermfg=15 guifg=" . s:light_blue
exec "highlight javaDebug ctermfg=15 guifg=" . s:light_blue
...
" For HTML.
exec "highlight htmlArg ctermfg=15 guifg=" . s:light_blue
...
" For vim files.
exec "highlight vimBracket ctermfg=15 guifg=" . s:light_blue
...
exec "highlight vimFuncSID ctermfg=15 guifg=" . s:light_blue
exec "highlight vimFunction ctermfg=15 guifg=" . s:light_blue
exec "highlight vimNotation ctermfg=15 guifg=" . s:light_blue
...
exec "highlight vimUserFunc ctermfg=15 guifg=" . s:light_blue
...
exec "highlight NERDTreeCWD ctermfg=9 guifg=" . s:magenta
exec "highlight NERDTreeDir ctermfg=15 guifg=" . s:light_blue
...
exec "highlight NERDTreeLinkDir ctermfg=2 guifg=" . s:blue
exec "highlight NERDTreeLinkFile ctermfg=2 guifg=" . s:blue
exec "highlight NERDTreeOpenable ctermfg=2 guifg=" . s:green
exec "highlight NERDTreePart ctermfg=2 guifg=" . s:grey0
exec "highlight NERDTreePartFile ctermfg=2 guifg=" . s:grey0
exec "highlight NERDTreeUp ctermfg=2 guifg=" . s:coral
...
exec "highlight Directory ctermfg=15 guifg=" . s:emerald
exec "highlight jsonKeyword ctermfg=15 guifg=" . s:light_blue
exec "highlight netrwClassify ctermfg=15 guifg=" . s:violet
exec "highlight netrwDir ctermfg=15 guifg=" . s:light_blue
